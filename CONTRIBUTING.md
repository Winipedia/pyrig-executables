...
Thanks for considering a contribution to pyrig-executables! Following
...
opening a new issue, search [existing issues](https://github.com/Winipedia/pyrig-executables/issues)
to avoid duplicates.
...
- All checks in [CI](https://github.com/Winipedia/pyrig-executables/actions/workflows/health_check.yml) must pass before merge.
